...
from dataset.Datatest import Dataset, get_training_augmentation, get_validation_augmentation, get_preprocessing
...
def main():
    ...
    for i in range(0, config.epochs):
        ...
        if max_score < valid_logs['iou_score']:
            ...
            mlflow.log_model(model, model_name, registered_model_name = 'model_' + config.network + '_' + config.encoder + '_' + config.loss + '_bsz' + str(config.batch))
            best_epoch = i            
